export const tables = {
    table1: {
        ...
        wireArea: ["2.08", "3.31", "5.26", "8.37", "13.3", "21.2", "26.7", "33.6", "42.4", "53.5", "67.4", "85.0", "107", "127", "152", "177", "203", "253", "304", "355", "380", "405", "456", "507", "633", "760", "887", "1010"],
        degree: [
            {
                temp: "60c",
                amps: ["25", "30", "40", "60", "80", "105", "120", "140", "165", "195", "220", "260", "300", "340", "370", "425", "455", "520", "580", "630", "655", "680", "730", "785", "890", "985", "1070", "1160"]
            },
            {
                temp: "75c",
                amps: ["30", "35", "50", "70", "95", "125", "145", "170", "195", "230", "265", "310", "360", "405", "445", "505", "545", "620", "690", "755", "785", "815", "870", "935", "1065", "1175", "1280", "1385"]
            },
            {
                temp: "90c",
                amps: ["35", "40", "55", "80", "105", "140", "165", "190", "220", "260", "300", "350", "405", "455", "500", "570", "615", "700", "780", "850", "885", "920", "980", "1055", "1200", "1325", "1445", "1560"]
            },
            {
                temp: "110c",
                amps: ["40", "45", "65", "90", "120", "160", "185", "215", "245", "290", "335", "390", "455", "500", "545", "615", "690", "785", "870", "955", "990", "1030", "1100", "1180", "1345", "1485", "1620", "1750"]
            },
            {
                temp: "125c",
                amps: ["40", "45", "65", "95", "130", "170", "195", "230", "265", "310", "355", "420", "485", "545", "600", "680", "735", "835", "930", "1020", "1060", "1100", "1175", "1260", "—", "—", "—", "—"]
            },
            {
                temp: "200c",
                amps: ["50", "55", "80", "115", "155", "205", "240", "275", "320", "375", "435", "510", "590", "—", "—", "—", "—", "—", "—", "—", "—", "—", "—", "—", "—", "—", "—"]
            }
        ]
    },
    table2: {
    ...
    table3: {
        ...
        wireArea: ["3.31", "5.26", "8.37", "13.3", "21.2", "26.7", "33.6", "42.4", "53.5", "67.4", "85.0", "107", "127", "152", "177", "203", "253", "304", "355", "380", "405", "456", "507", "633", "760", "887", "1010"],
        degree: [
            {
                temp: "60c",
                amps: ["25", "35", "45", "65", "85", "95", "115", "130", "150", "175", "200", "235", "265", "295", "330", "355", "405", "455", "500", "520", "540", "585", "630", "715", "795", "880", "965"]
            },
            {
                temp: "75c",
                amps: ["30", "40", "55", "75", "100", "115", "135", "155", "180", "210", "240", "280", "315", "350", "395", "425", "485", "545", "595", "620", "645", "700", "750", "855", "950", "1050", "1150"]
            },
            {
                temp: "90c",
                amps: ["35", "45", "60", "85", "115", "130", "150", "175", "205", "235", "270", "315", "355", "395", "445", "480", "545", "615", "670", "700", "725", "790", "845", "965", "1070", "1185", "1295"]
            },
            {
                temp: "110c",
                amps: ["40", "50", "70", "95", "125", "145", "170", "195", "225", "265", "305", "360", "410", "455", "505", "540", "615", "690", "750", "785", "815", "885", "950", "1080", "1200", "1325", "1455"]
            },
            {
                temp: "125c",
                amps: ["40", "55", "70", "100", "135", "160", "190", "215", "245", "280", "315", "365", "420", "460", "505", "545", "620", "690", "755", "785", "815", "885", "950", "1080", "1200", "1325", "1455"]
            },
            {
                temp: "200c",
                amps: ["50", "65", "90", "125", "170", "210", "245", "275", "315", "365", "430", "500", "585", "—", "—", "—", "—", "—", "—", "—", "—", "—", "—", "—", "—", "—", "—"]
            }
        ]
    },    
    table4: {
    ...
    table9: {
        rigidMetalConduit: {
            "16, 1/2": { diameter: 16.05 },
            "21, 3/4": { diameter: 21.23 },
            "27, 1": { diameter: 27.0 },
            "35, 1-1/4": { diameter: 35.41 },
            "41, 1-1/2": { diameter: 41.25 },
            "53, 2": { diameter: 52.91 },
            "63, 2-1/2": { diameter: 63.22 },
            "78, 3": { diameter: 78.49 },
            "91, 3-1/2": { diameter: 90.68 },
            "103, 4": { diameter: 102.87 },
            "129, 5": { diameter: 128.85 },
            "155, 6": { diameter: 154.76 }
        },
        flexibleMetalConduit: {
            "12, 3/8": { diameter: 9.52 },
            "16, 1/2": { diameter: 15.88 },
            "21, 3/4": { diameter: 20.62 },
            "27, 1": { diameter: 25.4 },
            "35, 1-1/4": { diameter: 31.75 },
            "41, 1-1/2": { diameter: 38.1 },
            "53, 2": { diameter: 50.8 },
            "63, 2-1/2": { diameter: 63.5 },
            "78, 3": { diameter: 76.2 },
            "91, 3-1/2": { diameter: 88.9 },
            "103, 4": { diameter: 101.6 }
        },
        rigidPVCConduit: {
            "16, 1/2": { diameter: 14.57 },
            "21, 3/4": { diameter: 19.77 },
            "27, 1": { diameter: 25.4 },
            "35, 1-1/4": { diameter: 31.75 },
            "41, 1-1/2": { diameter: 38.1 },
            "53, 2": { diameter: 50.8 },
            "63, 2-1/2": { diameter: 61.3 },
            "78, 3": { diameter: 76.2 },
            "91, 3-1/2": { diameter: 88.4 },
            "103, 4": { diameter: 100.1 },
            "129, 5": { diameter: 125.85 },
            "155, 6": { diameter: 149.75 },
            "200, 8": { diameter: 199.39 }
        },
        rigidTypeEB1PVCConduit: {
            ...
            "91, 3-1/2": { diameter: 88.4 },
            "103, 4": { diameter: 100.1 },
            "129, 5": { diameter: 126.35 },
            "155, 6": { diameter: 149.75 }
        },
        metallicLiquidTightFlexibleConduit: {
            "12, 3/8": { diameter: 12.29 },
            "16, 1/2": { diameter: 15.8 },
            "21, 3/4": { diameter: 20.83 },
            "27, 1": { diameter: 26.44 },
            "35, 1-1/4": { diameter: 35.05 },
            "41, 1-1/2": { diameter: 40.01 },
            "53, 2": { diameter: 51.31 },
            "63, 2-1/2": { diameter: 62.99 },
            "78, 3": { diameter: 77.98 },
            "91, 3-1/2": { diameter: 88.9 },
            "103, 4": { diameter: 101.6 }
        },
        nonMetallicLiquidTightFlexibleConduit: {
            "12, 3/8": { diameter: 12.07 },
            "16, 1/2": { diameter: 15.49 },
            "21, 3/4": { diameter: 20.45 },
            "27, 1": { diameter: 25.91 },
            "35, 1-1/4": { diameter: 34.54 },
            "41, 1-1/2": { diameter: 40.01 },
            "53, 2": { diameter: 51.69 }
        },
        electricalMetallicTubing: {
            "16, 1/2": { diameter: 15.4 },
            "21, 3/4": { diameter: 20.5 },
            "27, 1": { diameter: 26.2 },
            "35, 1-1/4": { diameter: 34.6 },
            "41, 1-1/2": { diameter: 40.5 },
            "53, 2": { diameter: 52.1 },
            "63, 2-1/2": { diameter: 69.4 },
            "78, 3": { diameter: 85.2 },
            "91, 3-1/2": { diameter: 97.4 },
            "103, 4": { diameter: 110.0 }
        },
        electricalNonMetallicTubing: {
            "16, 1/2": { diameter: 14.58 },
            "21, 3/4": { diameter: 19.66 },
            "27, 1": { diameter: 25.37 },
            "35, 1-1/4": { diameter: 33.73 },
            "41, 1-1/2": { diameter: 39.57 },
            "53, 2": { diameter: 51.18 }
        },
        rigidRTRCConduitMarkedIPS: {
            "16, 1/2": { diameter: 17.27 },
            "21, 3/4": { diameter: 22.61 },
            "27, 1": { diameter: 29.34 },
            "35, 1-1/4": { diameter: 38.1 },
            "41, 1-1/2": { diameter: 44.2 },
            "53, 2": { diameter: 56.26 },
            "63, 2-1/2": { diameter: 69.6 },
            "78, 3": { diameter: 84.84 },
            "103, 4": { diameter: 109.72 },
            "129, 5": { diameter: 136.14 },
            "155, 6": { diameter: 162.05 }
        },
        rigidRTRCConduitMarkedID: {
            "16, 1/2": { diameter: 11.94 },
            "21, 3/4": { diameter: 18.29 },
            "27, 1": { diameter: 24.64 },
            "35, 1-1/4": { diameter: 30.99 },
            "41, 1-1/2": { diameter: 37.34 },
            "53, 2": { diameter: 50.29 },
            "63, 2-1/2": { diameter: 63.0 },
            "78, 3": { diameter: 75.69 },
            "91, 3-1/2": { diameter: 88.39 },
            "103, 4": { diameter: 101.09 },
            "129, 5": { diameter: 126.24 }
        },
        HDPEConduitSchedule40: {
            "16, 1/2": { diameter: 14.67 },
            "21, 3/4": { diameter: 19.78 },
            "27, 1": { diameter: 25.4 },
            "35, 1-1/4": { diameter: 33.82 },
            "41, 1-1/2": { diameter: 39.63 },
            "53, 2": { diameter: 51.18 },
            "63, 2-1/2": { diameter: 61.13 },
            "78, 3": { diameter: 76.14 },
            "103, 4": { diameter: 100.26 },
            "129, 5": { diameter: 125.91 },
            "155, 6": { diameter: 151.5 },
            "200, 8": { diameter: 199.64 }
        },
        HDPEConduitSchedule80: {
            "16, 1/2": { diameter: 12.75 },
            "21, 3/4": { diameter: 17.7 },
            "27, 1": { diameter: 23.06 },
            "35, 1-1/4": { diameter: 31.1 },
            "41, 1-1/2": { diameter: 36.63 },
            "53, 2": { diameter: 47.82 },
            "63, 2-1/2": { diameter: 56.97 },
            "78, 3": { diameter: 71.38 },
            "103, 4": { diameter: 94.56 },
            "129, 5": { diameter: 119.25 },
            "155, 6": { diameter: 142.86 }
        },
        HDPEDR9Conduit: {
            "16, 1/2": { diameter: 15.47 },
            "21, 3/4": { diameter: 19.65 },
            "27, 1": { diameter: 24.86 },
            "35, 1-1/4": { diameter: 31.51 },
            "41, 1-1/2": { diameter: 36.1 },
            "53, 2": { diameter: 45.19 },
            "63, 2-1/2": { diameter: 54.63 },
            "78, 3": { diameter: 66.56 },
            "103, 4": { diameter: 85.36 },
            "129, 5": { diameter: 105.54 },
            "155, 6": { diameter: 125.63 },
            "200, 8": { diameter: 163.58 },
            "275, 10-7/8": { diameter: 203.84 }
        },
        HDPEDR11Conduit: {
            "16, 1/2": { diameter: 16.3 },
            "21, 3/4": { diameter: 20.73 },
            "27, 1": { diameter: 26.21 },
            "35, 1-1/4": { diameter: 33.31 },
            "41, 1-1/2": { diameter: 38.27 },
            "53, 2": { diameter: 47.91 },
            "63, 2-1/2": { diameter: 57.92 },
            "78, 3": { diameter: 70.6 },
            "103, 4": { diameter: 90.52 },
            "129, 5": { diameter: 111.93 },
            "155, 6": { diameter: 133.22 },
            "200, 8": { diameter: 173.49 },
            "275, 10-7/8": { diameter: 216.19 }
        },
        HDPEDR13_5Conduit: {
            "16, 1/2": { diameter: 17.02 },
            "21, 3/4": { diameter: 21.63 },
            "27, 1": { diameter: 27.33 },
            "35, 1-1/4": { diameter: 34.73 },
            "41, 1-1/2": { diameter: 39.93 },
            "53, 2": { diameter: 50.18 },
            "63, 2-1/2": { diameter: 60.68 },
            "78, 3": { diameter: 73.95 },
            "103, 4": { diameter: 94.83 },
            "129, 5": { diameter: 117.25 },
            "155, 6": { diameter: 139.57 },
            "200, 8": { diameter: 181.74 },
            "275, 10-7/8": { diameter: 226.49 }
        },
        HDPEDR15_5Conduit: {
            "16, 1/2": { diameter: 17.43 },
            "21, 3/4": { diameter: 22.14 },
            "27, 1": { diameter: 27.97 },
            "35, 1-1/4": { diameter: 35.54 },
            "41, 1-1/2": { diameter: 40.85 },
            "53, 2": { diameter: 51.4 },
            "63, 2-1/2": { diameter: 62.24 },
            "78, 3": { diameter: 75.85 },
            "103, 4": { diameter: 97.29 },
            "129, 5": { diameter: 120.29 },
            "155, 6": { diameter: 143.19 },
            "200, 8": { diameter: 186.43 },
            "275, 10-7/8": { diameter: 232.35 }
        }
    }
